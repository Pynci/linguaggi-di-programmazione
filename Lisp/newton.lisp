...
; la scrittura compresa tra * è una convenzione che indica un parametro
(defparameter *epsilon* 0.005)


; minusp ha valore true se v è positivo (stessa cosa per le altre due)
...
; c è la congetttura (quella che penso sia la radice quadrata)
